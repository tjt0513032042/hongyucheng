...
<script type="text/javascript" src="<%=basePath%>/js/summary/monthlist.js"></script>
        ...
        <form id="searchForm">
            <ul class="toolbar">
                <li style="border: 0px !important;">
                    <label>商家</label>&nbsp;<input type="text" name="shopId" class="dfinput" shopid="" readonly="readonly">
